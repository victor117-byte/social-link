    ...
    <div className="min-h-screen bg-transparent text-white flex flex-col items-center px-4 py-12 md:py-16">
      <div className="w-full max-w-md flex flex-col items-center">
        ...
        <div className="flex flex-col items-center mb-10 animate-fade-in">
          <div className="tron-border tron-glow p-1 rounded-full">
            <Avatar className="h-24 w-24 border-[3px] border-cyan-500/60 bg-[#080D16]">
              <img 
          ...
          <h1 className="mt-5 text-3xl font-bold tron-text">@tunombre</h1>
          <div className="mt-2 px-4 py-1 rounded-full tron-border bg-[#080D16]/80">
        ...
        <div className="mt-8 w-full animate-fade-in" style={{ animationDelay: "0.5s" }}>
          <h2 className="text-center mb-4 tron-text uppercase text-sm tracking-[4px]">Más contenido</h2>
        ...
        <footer className="mt-12 text-cyan-500/50 text-sm text-center animate-fade-in" style={{ animationDelay: "0.6s" }}>
          <div className="tron-border inline-block px-4 py-2 bg-[#080D16]/50">
